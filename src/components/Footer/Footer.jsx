...
const Footer = () => {
    return (
        ...
        <div className="px-4 pt-16 mx-auto sm:max-w-full md:max-w-full lg:max-w-full md:px-24 lg:px-8  bg-slate-600 m-0">
          {/* className='bg-slate-600 m-0' */}
        <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="sm:col-span-2">
            ...
            >
              <img className='h-7' src={'science.png'} alt="" />
